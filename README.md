...
```bash
git clone https://github.com/wa-bo/CuriosityBot-MD1. clone https://github.com/wa-bo/CuriosityBot-MD1.git && cd CuriosityBot-MD && yarn install && npm install -MD1 && cd CuriosityBot-MD && yarn install && npm install
```
